...
namespace StepCoin_v1
{
    public class Miner
    {
        ...
        public Miner(BlockChain blockChain, TransactionsValidator transValidator)
        {
            CopyOfBlockChain = blockChain;
            CopyOfTransactionValidator = transValidator;
        }

        public Block CreateNewBlock()
        {
            Block newBlock = new Block();
            newBlock.ThisHash = CalculateThisBlock(newBlock);
            newBlock.PreviousHash = CopyOfBlockChain.MyChain.Last.Value.ThisHash;
